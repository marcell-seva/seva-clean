const urls = {
  ...
  termsAndConditions: 'https://ext.seva.id/syarat-ketentuan',
  privacyPolicy: 'https://ext.seva.id/kebijakan-privasi',
  contactUs: 'https://www.start.torq.id/hubungi-kami',
  googlePlayHref: 'https://play.google.com/store/apps/details?id=id.seva',
  whatsappUrlPrefix: 'https://wa.me/',
  termsAndConditionsSeva: 'https://www.start.torq.id/syarat-ketentuan',
  privacyPolicySeva: 'https://www.start.torq.id/kebijakan-privasi',
