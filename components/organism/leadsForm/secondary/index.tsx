...
import styles from '_revamp/styles/organism/leadsFormSecondary.module.scss'
import {
  Button,
  Gap,
  IconLoading,
...
import { LoanRank, LocalStorageKey, SessionStorageKey } from 'models/models'
import { decryptValue, encryptValue } from 'utils/encryptionUtils'
import SupergraphicLeft from '_revamp/assets/illustration/supergraphic-small.webp'
import SupergraphicRight from '_revamp/assets/illustration/supergraphic-large.webp'
...
import { CarVariantListPageUrlParams } from '_revamp/pages/mobil-baru/[brand]/[variant]'
...
export const LeadsFormSecondary: React.FC<PropsLeadsForm> = ({}: any) => {
  ...
  const { brand, model } = useParams<CarVariantListPageUrlParams>()
