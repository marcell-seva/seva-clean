...
const CustomRight = '/v3/assets/illustration/custom-desktop-right.webp'
const CustomLeft = '/v3/assets/illustration/custom-desktop-left.webp'
const CustomMobile = '/v3/assets/illustration/custom-mobile-right.webp'
const ChristmasLeft = '/v3/assets/illustration/christmas-desktop-left.webp'
const ChristmasRight = '/v3/assets/illustration/christmas-desktop-right.webp'
const ChristmasMobileRight =
  '/v3/assets/illustration/christmas-mobile-right.webp'
const ChristmasMobileLeft = '/v3/assets/illustration/christmas-mobile-left.webp'
const NewYearLeft = '/v3/assets/illustration/newyear-desktop-left.webp'
const NewYearRight = '/v3/assets/illustration/newyear-desktop-right.webp'
const NewYearMobileRight = '/v3/assets/illustration/newyear-mobile-right.webp'
const NewYearMobileLeft = '/v3/assets/illustration/newyear-mobile-left.webp'
const CNYDesktopLeft = '/v3/assets/illustration/cny-desktop-left.svg'
const CNYDesktopRight = '/v3/assets/illustration/cny-desktop-right.svg'
const CNYMobileRight = '/v3/assets/illustration/cny-mobile-right.svg'
const CNYMobileLeft = '/v3/assets/illustration/cny-mobile-left.svg'
const RamadhanDesktopLeft = '/v3/assets/illustration/ramadhan-desktop-left.svg'
const RamadhanDesktopRight =
  '/v3/assets/illustration/ramadhan-desktop-right.svg'
const RamadhanMobileRight = '/v3/assets/illustration/ramadhan-mobile-right.svg'
const RamadhanMobileLeft = '/v3/assets/illustration/ramadhan-mobile-left.svg'
const IdulFitriDesktopLeft =
  '/v3/assets/illustration/idulfitri2023-desktop-left.svg'
const IdulFitriDesktopRight =
  '/v3/assets/illustration/idulfitri2023-desktop-right.svg'
const IdulFitriMobileRight =
  '/v3/assets/illustration/idulfitri2023-mobile-right.svg'
const IdulFitriMobileLeft =
  '/v3/assets/illustration/idulfitri2023-mobile-left.svg'
