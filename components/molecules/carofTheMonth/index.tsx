...
import CardCarOfTheMonth from '../carOfTheMonthCard'
...
const CarOfTheMonth = ({
  ...
  const getNaturalHeight = () => {
    if (isMobileSmall) return 65.2
    if (isMobileMedium) return 64.2
    if (isMobileLarge) return 60.2
    else return 44
  }
